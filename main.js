...
function showCard(n) {
    ...
    for (i = 0; i < cards.length; i++) {
        ...
        cards[i].classList.add = "team-card-active";
        btns[i].className.remove = "team-btn-active";
    }
    //顯示指定卡片，啟動對應按鈕
    cards[i_card].classList.remove = "team-card-active";
    btns[i_card].className.add = "team-btn-active";
}
